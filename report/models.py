...
class ReportOfDate(models.Model):
    ...
    total = models.IntegerField(verbose_name='Итого по периоду')
    income = models.PositiveIntegerField(verbose_name='Доходы по периоду')
    expenses = models.PositiveIntegerField(verbose_name='Расходы по периоду')
